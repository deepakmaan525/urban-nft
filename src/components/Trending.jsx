...
const Trending = () => {
    return (
        <div className='max-w-[712px] pt-11'>
            <div className="flex justify-between pb-4">
                <p className=' text-[#4F4F4F] text-base font-semibold leading-5'>Trendings NFTs</p>
                <p className="flex items-center text-[#4F4F4F] text-xs font-semibold leading-5">Marketplace <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
