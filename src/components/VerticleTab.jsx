...
const VerticleTab = () => {
  return (
    <div className="container max-[425px]:w-[90px] min-[426px]:w-[100px] min-[500px]:w-[200px] sm:w-[300px]">
      <div className="fixed max-[425px]:w-[90px] sm:w-[300px] min-[426px]:w-[100px] min-[500px]:w-[200px] py-8 px-6 bg-[#FFFDFF] h-full overflow-y-scroll scrollbar-hide">
        ...
        <div className="mt-16">
            ...
            <span>
              <svg className='fill-[#A8A8A8] duration-300 group-focus:fill-[url(#paint0_linear_33_463)]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" >
                ...
                <defs>
                  ...
                  <linearGradient
                    id="paint1_linear_33_463" x1="-0.586956" y1="-3.34868" x2="11.7002" y2="19.793" gradientUnits="userSpaceOnUse" >
                    <stop stop-color="#FFC881" />
                    <stop offset="1" stop-color="#DA8517" />
                  </linearGradient>
                </defs>
          ...
          <button className="flex gap-4 group focus:bg-gradient-to-r from-[#FBE8D5] to-[#FEF9F8] text-transparent items-center font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-3 bg-white w-full">
            <span>
              <svg className='fill-[#A8A8A8] duration-300 group-focus:fill-[url(#paint0_linear_33_463)]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                <path opacity="0.4" fill-rule="evenodd" clip-rule="evenodd" d="M3.43262 14.4413C3.43262 13.8113 3.94262 13.3013 4.57262 13.3013C5.19512 13.3013 5.70512 13.8113 5.70512 14.4413C5.70512 15.0638 5.19512 15.5738 4.57262 15.5738C3.94262 15.5738 3.43262 15.0638 3.43262 14.4413ZM11.8701 14.4413C11.8701 13.8113 12.3801 13.3013 13.0101 13.3013C13.6326 13.3013 14.1426 13.8113 14.1426 14.4413C14.1426 15.0638 13.6326 15.5738 13.0101 15.5738C12.3801 15.5738 11.8701 15.0638 11.8701 14.4413Z" fill="#A8A8A8" />
        ...
        <div className="mt-16">
          <p className="text-Black text-xs font-medium font-Inter pl-4 max-[500px]:hidden "> MY PROFILE</p>
          <button className="flex gap-4 group focus:bg-gradient-to-r from-[#FBE8D5] to-[#FEF9F8] text-transparent items-center  font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-4 bg-white w-full">
            <span>
              <svg className='fill-[#A8A8A8] duration-300 group-focus:fill-[url(#paint0_linear_33_463)]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <circle opacity="0.4" cx="13.625" cy="2.375" r="1.875" />
                <defs>
                  <linearGradient id="paint0_linear_33_463" x1="8.6924" y1="-1.14233" x2="13.9603" y2="8.69608" gradientUnits="userSpaceOnUse" >
                    <stop stop-color="#FFC881" />
                    <stop offset="1" stop-color="#DA8517" />
          ...
          <button className="flex group gap-4 focus:bg-gradient-to-r from-[#FBE8D5] to-[#FEF9F8] text-transparent items-center font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-3 bg-white w-full">
            <span>
              <svg className='fill-[#A8A8A8] duration-300 group-focus:fill-[url(#paint0_linear_33_463)]' xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14" fill="none" >
                ...
                <path opacity="0.4" d="M11.0281 7.22231C11.1849 7.93569 11.8104 8.43761 12.5244 8.42456H14.9619C15.259 8.42456 15.5 8.17849 15.5 7.87434V5.97567C15.4994 5.67217 15.259 5.42546 14.9619 5.4248H12.4671C11.6548 5.42742 10.9987 6.10164 11 6.93251C11 7.02976 11.0096 7.12701 11.0281 7.22231Z" />
                <circle cx="12.5" cy="6.9248" r="0.75" />
                <defs>
                  <linearGradient id="paint0_linear_33_463" x1="8.6924" y1="-1.14233" x2="13.9603" y2="8.69608" gradientUnits="userSpaceOnUse" >
                    <stop stop-color="#FFC881" />
                    <stop offset="1" stop-color="#DA8517" />
          ...
          <button className="flex group gap-4 focus:bg-gradient-to-r from-[#FBE8D5] to-[#FEF9F8] text-transparent items-center font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-3 bg-white w-full">
            <span>
              <svg className='fill-[#A8A8A8] duration-300 group-focus:fill-[url(#paint0_linear_33_463)]' xmlns="http://www.w3.org/2000/svg" width="12" height="16" viewBox="0 0 12 16" fill="none">
                <path d="M5.99775 10.3813C2.763 10.3813 0 10.8913 0 12.9313C0 14.9721 2.74575 15.5001 5.99775 15.5001C9.2325 15.5001 11.9955 14.9908 11.9955 12.9501C11.9955 10.9093 9.2505 10.3813 5.99775 10.3813Z" />
                <path opacity="0.4" d="M5.99732 8.438C8.20082 8.438 9.96632 6.67175 9.96632 4.469C9.96632 2.26625 8.20082 0.5 5.99732 0.5C3.79457 0.5 2.02832 2.26625 2.02832 4.469C2.02832 6.67175 3.79457 8.438 5.99732 8.438Z" />
                <defs>
                  <linearGradient id="paint0_linear_33_463" x1="8.6924" y1="-1.14233" x2="13.9603" y2="8.69608" gradientUnits="userSpaceOnUse" >
                    <stop stop-color="#FFC881" />
                    <stop offset="1" stop-color="#DA8517" />
          ...
          <button className="flex group gap-4 focus:bg-gradient-to-r from-[#FBE8D5] to-[#FEF9F8] text-transparent items-center font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-3 bg-white w-full">
            <span>
              <svg className='fill-[#A8A8A8] duration-300 group-focus:fill-[url(#paint0_linear_33_463)]' xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none" >
                <path d="M8.0088 10.1223C6.80545 10.1223 5.83203 9.18477 5.83203 8.00727C5.83203 6.82977 6.80545 5.88477 8.0088 5.88477C9.21216 5.88477 10.1626 6.82977 10.1626 8.00727C10.1626 9.18477 9.21216 10.1223 8.0088 10.1223Z" />
          ...
          <button className="flex group gap-4 focus:bg-gradient-to-r from-[#FBE8D5] to-[#FEF9F8] text-transparent items-center font-semibold text-sm font-Inter py-[14px] px-[15px] rounded-full mt-3 bg-white w-full">
            ...
            <span className=" text-[#7C7C7C] font-inter  max-[500px]:hidden group-focus:bg-gradient-to-b group-focus:from-[#FFC881] from-15% group-focus:to-[#DA8517] group-focus:bg-clip-text group-focus:text-transparent ">Log out</span>
          </button>
        </div>
      </div>
    </div>
