...
const MetroVerse = () => {
  ...
  return (
    ...
    <div className="bg-white bg-[url(./assets/images/metroSecBg.png)] bg-no-repeat bg-cover rounded-[18px] shadow mt-9 relative max-w-[712px]">
      <div className="sm:p-7 p-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="flex flex-col justify-center order-2 lg:order1">
            <div className=" text-base font-medium font-Inter leading-tight font-inter bg-gradient-to-b from-[#ECA54A] from-15% to-[#E59937] bg-clip-text text-transparent ">Create MetroVerse Genesis </div>
            ...
            <div className="lg:max-w-[290px] mt-[30px]">
              <div className="max-w-[140px]"><button className="btn bg-gold-gradient text-white shadow-[6px_4px_25px_0_rgba(229,156,62,0.34)] rounded-full w-full font-Inter bg-gradient-to-b from-[#FFC881] from-15% to-[#DA8517] font-medium text-sm py-2 px-4">Explore Now</button></div>
